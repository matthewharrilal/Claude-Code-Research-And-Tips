 ...
 *   SC-01 (K1): Container width            940-960px
...
async function runSpatialGate(page) {
  ...
  const results = await page.evaluate(() => {
    ...
    // PASS if 940-960px. This is the single most critical spatial check --
    ...
    (function checkSC01() {
      ...
      if (!container) {
        output.push({
          ...
          action: 'Add a content wrapper with max-width: 960px; margin: 0 auto.'
        });
        return;
      }
