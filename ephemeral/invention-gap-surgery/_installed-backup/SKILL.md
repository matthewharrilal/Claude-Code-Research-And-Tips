...
- `{OUTPUT_DIR}/_package-pass-1.md` — **Foundations** (~230-280 lines)
...
**NOTE:** The weaver DOES receive `_builder-reflection.md` for the Section 10 Assessment only — read AFTER completing experiential Outputs 1-3. Do NOT read other reflection sections that contain builder intent.
