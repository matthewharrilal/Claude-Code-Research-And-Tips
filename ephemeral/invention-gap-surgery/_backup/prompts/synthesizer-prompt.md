...
### File 1: `_package-pass-1.md` — FOUNDATIONS (~230-280 lines)
...
5. BUILD the HTML skeleton: zones first, then mechanisms, then responsive.
6. As you build, let the questions from Section 10 INFORM your CSS decisions across
...
**Three question sources (assemble 5-7 questions total):**
...
**Source 2: Knowledge Base Question Families (2-3 questions, adapted)**
...
**Adaptation instruction:** Do NOT copy template questions verbatim. Rewrite each in the vocabulary of THIS content's metaphor. Replace bracket placeholders with specific content features. Each adapted question must imply 3+ CSS properties varying together.
...
- Minimum 5 questions, maximum 7 (cognitive load management)
...
- [ ] `_package-pass-1.md`: 230-280 lines, contains Sections 0, 1, 2, 9, 10 (increased from 130-170: +30-40 for Section 10, +30-40 for richer mechanism selections in Section 2)
...
- [ ] Total across 3 files: 550-690 lines (increased from 400-600 to accommodate Section 10 + richer mechanism selections + question attributions)
...
- [ ] Section 10 (Compositional Questions) includes 5-7 questions from 3 sources, each implying 3+ CSS channels
