...
|------|----------|-------|----------|
| `pa-questions.md` | 69 PA question definitions (PA-01–PA-77) | ~431 | PA Auditors (assigned subset only) |
| `pa-deployment.md` | 9-auditor assignments, screenshot protocol, fresh-eyes rules | ~442 | Orchestrator |
| `pa-weaver.md` | Weaver protocol, verdicts, calibration (INFORMATION ISOLATION) | ~468 | Weaver ONLY |
| `pa-guardrails.md` | Auditor constraints, scoring anchors | ~113 | PA Auditors |
