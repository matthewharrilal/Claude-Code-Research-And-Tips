...
### 4.2.1 Cross-Viewport Comparison Requirements
...
### 5.1.1 Expected Screenshot Count
...
| PA-05 >= 3/4 AND all identity gates PASS AND <= 3 MECHANICAL fixes needed | **SHIP WITH FIXES** (see 10.1.1) |
| PA-05 2.5-3.5 | **REFINE** (see 10.2) |
| PA-05 < 2.5 | **REBUILD** (see 10.3) |

#### 10.1.1 SHIP WITH FIXES Protocol
