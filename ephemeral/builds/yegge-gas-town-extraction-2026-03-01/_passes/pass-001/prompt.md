...
This page lives in the part of the KortAI world where the machinery is exposed. Where precision serves not elegance but *force* — the industrial quarter where editorial confidence meets operational brutality. The warm earth tones here carry soot. The sharp edges are functional, not aesthetic. Red appears not for attention but for alarm.

## Opposition

The central tension is **wildness against architecture**. The content celebrates chaos with the fervor of a manifesto — "smuggled 400 miles upriver in my ass," Mad Max naming conventions, $80,000/year in API costs treated as the price of doing business, vibe coding that means *never reading your own code*. Simultaneously, it presents one of the most rigidly hierarchical systems in the document set: eight named roles in explicit layers, a three-tier memory model, precise CLI grammars, cost tables calculated to the decimal.

Neither side can win. Sanitize the punk energy and you produce documentation for a tool that could be any tool. Surrender to the chaos and you betray the engineering precision that makes Gas Town *work*. The page must hold both truths: that this system was born from recklessness and survives through rigor. The reader must feel the wildness as evidence of conviction, and the architecture as evidence of competence. The builder's job is to make these two energies *reinforce* rather than cancel.

## Metaphor

The content reveals itself as a **cross-section of an industrial facility** — not toured room by room, but sliced open vertically so all layers are visible simultaneously, the way an engineering diagram exposes a building's anatomy.

The top layer is the **street level**: who built this place, why it exists, the philosophy painted on the walls. This is where Yegge's voice lives, where the quotes hit, where the reader decides if they trust the architect.

The middle layer is the **factory floor**: the 8 roles in their hierarchy, the communication flows, the assignment chains. This is the largest zone — the structural heart. It has the density of machinery. Components here are load-bearing.

Below the floor is the **plumbing**: Beads, git-backed memory, the three-tier context model. This is where persistence lives, where the "50 First Dates" problem gets solved in infrastructure. It should feel *beneath* the roles, supporting them invisibly.

Flanking the facility is the **context wall**: the 6 waves of AI, the 8 stages of dev evolution, the core principles. These are not inside the machine — they are the *reasons* the machine was built. They provide historical and philosophical framing.

At ground level again, the **operations manual**: installation, tmux layout, daily workflow, troubleshooting. This is where the reader re-enters their own world, carrying what they've seen.

Finally, the **map room**: comparisons with Ralph, CC Mirror, Orchestra. The reader steps back, sees the landscape, locates Gas Town within it.

The cross-section metaphor governs density: street level is sparse and confrontational, factory floor is dense and structural, plumbing is deep and technical, context wall is medium and philosophical, operations manual is utilitarian and scannable, map room is comparative and resolving.

## Arc

**Opening (Street Level):** Confrontation. The reader meets a voice that does not apologize. "The world's biggest fuckin' ant." The feeling should be *provocation* — not hostility, but the sharp awareness that this content will not coddle. Yegge's credibility establishes quickly: 40 years, a million lines vibe-coded, recursive self-validation. The reader should feel they are in the presence of earned authority.

**Development (Factory Floor):** Awe through comprehension. The 8 roles unfold not as a list but as a *system* — each role's existence implying the others. Mayor routes. Refinery decomposes. Polecats execute. Witness observes. Dogs guard. The reader should feel the architecture clicking together like industrial machinery engaging. This is the density peak. The reader should feel *surrounded* by moving parts, but never lost — each role is named, bounded, purposeful.

**Deepening (Plumbing):** Quiet respect. Beads solves a problem the reader has felt but couldn't name. The "50 First Dates" metaphor lands with recognition. The three-tier memory model is elegant. The reader should feel *relief* — this problem has been thought through.

**Widening (Context Wall):** Historical perspective. The 6 waves locate Gas Town in time. The 8 stages locate the reader in competence. The feeling should be *orientation* — "now I know where I am, and where this is going."

**Grounding (Operations):** Practical confidence. Commands, scripts, tmux layouts. The feeling shifts from awe to agency: "I could actually do this." Troubleshooting sections provide safety — "and if it breaks, here's what to do."

**Resolution (Map Room):** Clarity through comparison. The reader sees Gas Town alongside alternatives and understands not just what it is, but what it *isn't*, and when it's appropriate. The feeling is *equipped judgment*.

## Content Map

**Zone 1 — Street Level** (Sections: You Are Here, Who is Steve Yegge, The Gas Town Mental Model)
Low spatial density. High semantic density. The "You Are Here" complexity ladder is a single orienting artifact — vertical, sharp, declarative. Yegge's background is tabular but sparse. The core insight ("ant vs. colony") wants the most generous whitespace on the page — it is the single idea everything else serves. Pull quotes from Yegge bleed wide here. This zone *breathes*.

**Zone 2 — Factory Floor** (Section: The 8 Roles Architecture)
Maximum density. The hierarchy diagram is the visual centerpiece of the entire page. Eight role cards, each with function, responsibilities, commands, model recommendation. The communication flow diagram is the second major artifact. This zone should feel *mechanical* — components arranged with the precision of a schematic. Density stays HIGH throughout but varies in *kind*: diagram density, then card density, then flow density.

**Zone 3 — Plumbing** (Section: Beads: The Memory System)
Medium-high density, more vertical than Zone 2. The memory model diagram is the key artifact. The "50 First Dates" problem statement opens with recognition. The "why markdown fails" table provides contrast. Git-as-database rationale closes. This zone should feel *subterranean* — supporting infrastructure made visible.

**Zone 4 — Context Wall** (Sections: The 6 Waves of AI, Core Principles)
Medium density. Two tables (waves, stages) provide historical structure. GUPP, Zero Framework Cognition, Cattle Not Pets — these are principle statements that want the Essence Callout treatment. This zone is philosophical. It should feel like stepping back from the machinery to understand *why it was built this way*.

**Zone 5 — Operations Manual** (Sections: Implementation Guide, Checkpoints, Troubleshooting)
Utilitarian density. Code blocks dominate. The tmux diagram is practical, not conceptual. Troubleshooting entries are symptom/cause/recovery triplets — scannable by design. This zone should feel *usable* — reference material that respects the reader's time.

**Zone 6 — Map Room** (Sections: When to Use, Comparisons, Sources)
Comparative density. Three comparison tables (vs Ralph, vs CC Mirror, vs Orchestra) plus the decision flowchart and the orchestrator spectrum. The reader needs to *judge*, not just absorb. This zone resolves through clarity of choice.

## Mechanism Affinity

**Pull quotes that bleed margins** — Yegge's voice is the strongest single element in this content. His quotes are profane, vivid, and structurally important. They should interrupt the grid the way his ideas interrupt conventional thinking. This is where red (#E83025) earns its appearance.

**Editorial spread pattern** — The 8 roles section is a natural editorial spread: structural diag
...
### Frontmatter (before first numbered section)

| Element | Level | ~Words | Content Type | Density |
|---------|-------|--------|-------------|---------|
| Steve Yegge and Gas Town: Complete Extraction | h1 | — | title | — |
| D-FINAL Connection block | none (bold + rule) | 20 | metadata prose | sparse |
| Tagline blockquote | none (blockquote) | 12 | quote | sparse |
| Table of Contents | h2 | 80 | numbered list | sparse |

### Numbered Sections

| Section | Level | ~Words | Content Type | Density |
|---------|-------|--------|-------------|---------|
| You Are Here | h2 | 250 | mixed: ASCII diagram, prose, checklist, list | medium |
| 1. Who is Steve Yegge? | h2 | 350 | mixed: table, lists, quote, prose | medium |
| — Professional Background | h3 | 90 | table + prose | medium |
| — Why His Opinion Matters | h3 | 60 | list | dense |
| — Public Presence | h3 | 40 | list | sparse |
| — The "Vibe Coding" Pioneer | h3 | 100 | quote + prose + list | medium |
| 2. The Gas Town Mental Model | h2 | 300 | mixed: quote, ASCII, table, prose, list | medium |
| — The Core Insight | h3 | 80 | quote + ASCII diagram | medium |
| — The Factory Metaphor | h3 | 70 | table + prose | medium |
| — The "Idea Compiler" | h3 | 60 | quote + prose | medium |
| — Why "Gas Town"? | h3 | 50 | list | sparse |
| 3. The 8 Roles Architecture | h2 | 950 | mixed: ASCII, prose, code, quote, table | dense |
| — Hierarchy Overview | h3 | 150 | ASCII diagram (large) | dense |
| — Role Deep Dives | h3 | — | container heading | — |
| —— 1. Mayor | h4 | 80 | prose + code | medium |
| —— 2. Deacon | h4 | 65 | prose + code | medium |
| —— 3. Dogs | h4 | 65 | prose + code | medium |
| —— 4. Refinery | h4 | 80 | prose + code | medium |
| —— 5. Polecat | h4 | 90 | prose + code + note | medium |
| —— 6. Witness | h4 | 65 | prose + code | medium |
| —— 7. Crew | h4 | 65 | prose + code | medium |
| —— 8. Overseer | h4 | 75 | prose + quote | medium |
| — Role Communication Flow | h3 | 80 | ASCII diagram | dense |
| 4. Beads: The Memory System | h2 | 400 | mixed: quote, table, list, ASCII, code | dense |
| — The "50 First Dates" Problem | h3 | 30 | quote | sparse |
| — Why Markdown Plans Fail at Scale | h3 | 50 | table | dense |
| — What Beads Does | h3 | 80 | prose + list | medium |
| — Beads Architecture | h3 | 30 | ASCII diagram | dense |
| — Key Beads Commands | h3 | 30 | code | medium |
| — Memory Model | h3 | 70 | ASCII diagram | dense |
| — Why Git as Database? | h3 | 60 | quote + list | medium |
| 5. The 6 Waves of AI | h2 | 200 | mixed: table, quote | dense |
| — The 8 Stages of Dev Evolution | h3 | 100 | table + quote | dense |
| 6. Core Principles | h2 | 350 | mixed: quote, prose, list | dense |
| — GUPP: The Universal Propulsion Principle | h3 | 100 | quote + prose + list | dense |
| — Zero Framework Cognition | h3 | 30 | quote + prose | dense |
| — Agents as Cattle, Not Pets | h3 | 45 | list | dense |
| — Nondeterministic Idempotence | h3 | 55 | list | dense |
| — Token Spend as Health Metric | h3 | 70 | quote + list | dense |
| — Talk to the Plan, Not the Agent | h3 | 45 | list | medium |
| 7. Implementation Guide | h2 | 550 | mixed: checklist, code, ASCII, prose | medium |
| — Prerequisites Checklist | h3 | 50 | checklist | sparse |
| — Installation | h3 | 35 | code | sparse |
| — Adding Your First Rig | h3 | 25 | code | sparse |
| — Starting the Core Roles | h3 | 50 | code + prose | medium |
| — tmux Workflow | h3 | 50 | ASCII diagram | medium |
| — Startup Script | h3 | 200 | code (long bash script) | medium |
| — Typical Daily Workflow | h3 | 80 | code with comments | medium |
| 8. Checkpoints and Verification | h2 | 150 | mixed: table, code | medium |
| — Post-Installation Checkpoints | h3 | 50 | table | medium |
| — Health Checks | h3 | 50 | code + list | medium |
| — Quality Verification | h3 | 30 | code | sparse |
| 9. Troubleshooting | h2 | 450 | mixed: prose, code, pattern-based | medium |
| — Common Failures and Recovery | h3 | — | container heading | — |
| —— 1. Context Collapse | h4 | 50 | symptom/cause/recovery + code | medium |
| —— 2. Race Conditions / Merge Conflicts | h4 | 60 | symptom/cause/recovery + code | medium |
| —— 3. Runaway Crew | h4 | 55 | symptom/cause/recovery + code | medium |
| —— 4. Mayor Deadlock | h4 | 45 | symptom/cause/recovery + code | medium |
| —— 5. Beads Desync | h4 | 40 | symptom/cause/recovery + code | medium |
| —— 6. Agent Won't Start | h4 | 50 | symptom/cause/recovery + code | medium |
| — Recovery Command Reference | h3 | 80 | code | medium |
| 10. When to Use Gas Town | h2 | 250 | mixed: lists, ASCII diagram | medium |
| — Use Gas Town When | h3 | 70 | list | medium |
| — Don't Use Gas Town When | h3 | 60 | list | medium |
| — Decision Matrix | h3 | 70 | ASCII flowchart | medium |
| 11. Quotes and Key Statements | h2 | 300 | quotes only | sparse |
| — On the Core Philosophy | h3 | 65 | quotes | sparse |
| — On Expectations | h3 | 40 | quotes | sparse |
| — On Prerequisites | h3 | 30 | quotes | sparse |
| — On Maturity | h3 | 25 | quotes | sparse |
| — On Cost | h3 | 20 | quotes | sparse |
| — On Language Choice | h3 | 25 | quotes | sparse |
| — On Agents | h3 | 35 | quotes | sparse |
| 12. Comparison with Other Patterns | h2 | 500 | mixed: tables, prose, ASCII | dense |
| — Gas Town vs Ralph Wiggum | h3 | 140 | table + prose | dense |
| — Gas Town vs CC Mirror | h3 | 140 | table + quote + prose | dense |
| — Gas Town vs Infinite Orchestra | h3 | 120 | table + prose | dense |
| — Pattern Comparison Summary | h3 | 60 | ASCII diagram | dense |
| 13. Sources | h2 | 250 | lists, links, table | sparse |
| — Primary Sources | h3 | — | container | — |
| —— Blog Posts | h4 | 50 | link list | sparse |
| —— GitHub Repositories | h4 | 50 | link list | sparse |
| —— Podcasts & Interviews | h4 | 25 | link list | sparse |
| —— Twitter/X | h4 | 25 | link list | sparse |
| — Community Extensions | h3 | 50 | table | sparse |
| — Installation | h3 | 30 | code | sparse |
| — Books | h3 | 15 | single entry | sparse |
| Appendix: Quick Reference | h2 | 200 | code | medium |
| Cost Estimation | h2 | 100 | code-formatted table | dense |
| Tags | h2 | 30 | inline tags | sparse |
| Document Metadata | h2 | 40 | list | sparse |

**Total estimated word count: ~5,700**
...
- Section 3 (8 Roles Architecture) → Role Deep Dives → individual roles (h2 → h3 → h4, 8 instances)
- Section 9 (Troubleshooting) → Common Failures → individual failures (h2 → h3 → h4, 6 instances)
- Section 13 (Sources) → Primary Sources → source categories (h2 → h3 → h4, 4 instances)

**Structural orphans:**
- D-FINAL Connection block — sits between h1 title and first h2, under no heading
- Tagline blockquote — floats between D-FINAL block and Table of Contents
- Closing quote (*"Build a colony..."*) — sits after Document Metadata, belongs to no section
- Horizontal rules function as separators throughout but create visual orphan boundaries between title and first content

---

## 3. Content Type Distribution

| Content Type | Estimated % | Notes |
|-------------|-------------|-------|
| Prose | 20% | Short paragraphs, rarely exceeding 3 sentences |
| Code / ASCII diagrams | 30% | Bash commands, ASCII architecture diagrams, startup scripts |
| Lists (bulleted/numbered/checklist) | 18% | Prerequisites, principles, features, troubleshooting patterns |
| Tables | 15% | Comparison matrices, role summaries, wave frameworks |
| Blockquotes | 10% | Yegge quotes used as structural anchors throughout |
| M
...
Rotation A, pass 1 of 8, subset 1 of 7 (global pass 1)

### Content Chunk Instructions

This is CHUNK 1 of 5. CREATE the page from scratch with these sections: (preamble), D-FINAL Connection, Table of Contents, You Are Here, 1. Who is Steve Yegge?, 2. The Gas Town Mental Model. Build the full HTML structure (DOCTYPE, head, styles, body, header, main, footer). Design the CSS architecture, zone system, and typography for the ENTIRE page — even though you're only building the first sections now. Leave a clear insertion point (<!-- NEXT_CHUNK -->) at the end of main content where subsequent sections will be added.
