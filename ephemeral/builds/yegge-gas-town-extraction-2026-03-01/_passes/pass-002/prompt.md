...
<head>
  ...
  <style>
    /* ═══════════════════════════════════════════════════════════════════════
       ROOT TOKENS — Design system vocabulary for the entire page
       Source: design-system/specification/tokens/*.md
       Verification: CD-006-pilot-migration.html, DD-006-fractal.html
       ═══════════════════════════════════════════════════════════════════════ */
    :root {
      /* SOUL CONSTRAINTS — immutable, non-negotiable */
      --border-radius: 0;
      --box-shadow: none;
      ...
      /* FACILITY ZONE BACKGROUNDS — the cross-section layers
         All satisfy R >= G >= B (warm palette enforced)
         Named by facility metaphor, not by position */
      /* R3: density dimensions → zone backgrounds encode semantic depth */
      --zone-exterior: #1A1A1A;
      --zone-street: #FEF9F5;
      --zone-street-warm: #F8F3EB;
      --zone-grit: #F5F0E6;
      --zone-factory: #F0EBE3;
      --zone-factory-deep: #EBE5DA;
      --zone-machinery: #1A1A1A;
      --zone-plumbing: #EDE7DC;
      --zone-context: #FAF5ED;
      --zone-ops: #F8F5EF;
      --zone-map: #FBF6EE;

      /* TYPOGRAPHY — font trinity, locked */
      --font-display: 'Instrument Serif', Georgia, serif;
      --font-body: 'Inter', system-ui, sans-serif;
      --font-mono: 'JetBrains Mono', 'SF Mono', monospace;

      /* TYPE SCALE — display-body gap >= 10px */
      --type-hero: 2.75rem;
      --type-section: 2rem;
      ...
      /* BORDERS — 3-category system (NEVER 2px) */
      --border-structural: 4px;
      --border-accent: 3px;
      --border-micro: 1px;

      /* ACCENT COLORS — callout border semantics */
      --accent-blue: #4A90D9;
      --accent-green: #4A9D6B;
      --accent-coral: #C97065;
      --accent-amber: #D97706;
      ...
      /* SYNTAX HIGHLIGHTING — dark background code zones */
    ...
    *:focus-visible {
    ...
    /* ═══════════════════════════════════════════════════════════════════════
       HEADER — Facility Exterior
       Dark shell with red alarm stripe at the threshold.
       The reader enters through here. Confrontation, not welcome.
       ═══════════════════════════════════════════════════════════════════════ */
    /* R2: editorial confidence → dark header as authority signal */
    header {
      background: var(--zone-exterior);
      color: var(--color-bg);
      border-bottom: var(--border-accent) solid var(--color-primary);
    }
    ...
    /* ═══════════════════════════════════════════════════════════════════════
       TABLE OF CONTENTS — Facility Directory
       Posted at the entrance. Clean, functional, mono-numbered.
       ═══════════════════════════════════════════════════════════════════════ */
    .toc {
      background: var(--zone-street-warm);
    ...
    /* ═══════════════════════════════════════════════════════════════════════
       PULL QUOTES — Yegge's Voice Interrupting the Grid
       These bleed beyond the content width. Red border = alarm.
       The strongest single element in the content.
       ═══════════════════════════════════════════════════════════════════════ */
    /* R2: creative layouts → pull quotes bleed margins to interrupt grid */
    /* RESEARCH-SYNTHESIS: editorial confidence through typography */
    .pull-quote {
      margin-left: calc(-1 * var(--space-8));
      margin-right: calc(-1 * var(--space-8));
      padding: var(--space-10) var(--space-8);
      border-left: var(--border-structural) solid var(--color-primary);
      background: var(--zone-grit);
      font-family: var(--font-display);
      font-style: italic;
    ...
    /* Dominant variant — the single idea everything else serves */
    /* Conviction brief: "most generous whitespace on the page" */
    .pull-quote--dominant {
      margin-top: var(--space-16);
      margin-bottom: var(--space-16);
      padding: var(--space-16) var(--space-8);
      font-size: var(--type-quote-dominant);
    }

    /* ═══════════════════════════════════════════════════════════════════════
       CALLOUT FAMILY — 2-Zone DNA
       4px left border (structural), sparse label + dense body.
       All variants share this structure; color differentiates.
       ═══════════════════════════════════════════════════════════════════════ */
    /* R5: combination theory → callout family shares structural DNA */
    .callout {
      border-left: var(--border-structural) solid;
    ...
    /* Gotcha — alarm. Red appears here for warning, not decoration. */
    .callout--gotcha {
      border-left-color: var(--color-primary);
      background: #FEF6F5;
    }
    .callout--gotcha .callout-label { color: var(--color-primary); }

    /* Essence — Instrument Serif italic (the system's deepest voice) */
    .callout--essence {
      border-left-color: var(--accent-amber);
      background: var(--zone-context);
    }
    .callout--essence .callout-label { color: var(--accent-amber); }
    ...
    /* Challenge — invitation to act */
    .callout--challenge {
      border-left-color: var(--accent-purple);
      background: #FAF7F4;
    }
    .callout--challenge .callout-label { color: var(--accent-purple); }

    /* ═══════════════════════════════════════════════════════════════════════
       CODE BLOCKS — Exposed Machinery
       Dark background, syntax highlighting. The factory's innards.
       ═══════════════════════════════════════════════════════════════════════ */
    .code-block {
      background: var(--zone-machinery);
      color: var(--color-bg);
      border: var(--border-accent) solid var(--color-border);
    ...
    /* ═══════════════════════════════════════════════════════════════════════
       TABLES — Sharp data grids
       3px header border, 1px row dividers. Mechanical precision.
       ═══════════════════════════════════════════════════════════════════════ */
    .data-table {
      width: 100%;
    ...
    .data-table th {
      ...
      text-align: left;
      border-bottom: var(--border-accent) solid var(--color-border);
      color: var(--color-text-secondary);
    }

    .data-table td {
      padding: var(--space-3) var(--space-4);
      border-bottom: var(--border-micro) solid var(--color-border);
      vertical-align: top;
      line-height: 1.6;
    }
    ...
    /* ═══════════════════════════════════════════════════════════════════════
       COMPLEXITY LADDER — Orienting Schematic
       Vertical, sharp, declarative. Posted at the entrance like a map.
       ═══════════════════════════════════════════════════════════════════════ */
    /* Conviction brief: "single orienting artifact — vertical, sharp, declarative" */
    .ladder {
      background: var(--zone-street-warm);
      border: var(--border-accent) solid var(--color-border);
      padding: var(--space-8);
    ...
    .ladder-level {
      ...
      gap: var(--space-4);
      padding: var(--space-3) var(--space-4);
      border-left: var(--border-micro) solid var(--color-border);
    }
    ...
    .ladder-level--active .ladder-num {
      color: var(--color-primary);
      font-weight: 600;
    }
    ...
    .ladder-level--active .ladder-name {
      font-weight: 600;
      color: var(--color-primary);
    }
    ...
    /* ═══════════════════════════════════════════════════════════════════════
       COMPARISON LAYOUT — Two Columns, Stark Contrast
       Traditional vs Gas Town. Architecture containing opposition.
       ═══════════════════════════════════════════════════════════════════════ */
    .comparison {
      display: grid;
    ...
    .comparison-col:first-child {
      border-right: var(--border-micro) solid var(--color-border);
    }
    ...
    .comparison-col--old .comparison-heading {
      color: var(--color-text-secondary);
    }

    .comparison-col--new .comparison-heading {
      color: var(--color-primary);
    }

    .comparison-row {
      padding: var(--space-3) 0;
      border-bottom: var(--border-micro) solid var(--color-border-subtle);
      font-size: var(--type-body);
      line-height: 1.6;
    }
    ...
    /* ═══════════════════════════════════════════════════════════════════════
       CHECKLIST — Prerequisites, practical requirements
       ═══════════════════════════════════════════════════════════════════════ */
    .checklist {
      list-style: none;
    ...
    /* ═══════════════════════════════════════════════════════════════════════
       CONTENT LIST — Bullet lists with em dashes
       ═══════════════════════════════════════════════════════════════════════ */
    .content-list {
      list-style: none;
      margin: var(--space-4) 0;
    ...
    /* ═══════════════════════════════════════════════════════════════════════
       CREDENTIAL STATS — Career highlights as a grid
       ═══════════════════════════════════════════════════════════════════════ */
    .credential-grid {
      display: grid;
    ...
    /* ═══════════════════════════════════════════════════════════════════════
       DROP CAP — Editorial opening signal
       ═══════════════════════════════════════════════════════════════════════ */
    ...
    /* ═══════════════════════════════════════════════════════════════════════
       CORE ABSTRACTION — Composite: principle + code proof
       Reserved for deep architectural insight moments.
       ═══════════════════════════════════════════════════════════════════════ */
    .core-abstraction {
      border: var(--border-accent) solid var(--color-border);
      margin: var(--space-8) 0;
    ...
    /* ═══════════════════════════════════════════════════════════════════════
       REASONING COMPONENT — Deliberation container
       ═══════════════════════════════════════════════════════════════════════ */
    .reasoning {
      border: var(--border-accent) solid var(--color-border);
      margin: var(--space-8) 0;
    ...
    .reasoning-recommendation {
      padding: var(--space-6) var(--space-8);
      background: #F8F6F2;
      border-top: var(--border-accent) solid var(--accent-green);
    }
    ...
    /* ═══════════════════════════════════════════════════════════════════════
       TASK COMPONENT — Checklist container
       ═══════════════════════════════════════════════════════════════════════ */
    .task-component {
      border: var(--border-accent) solid var(--color-border);
      margin: var(--space-6) 0;
    ...
    /* ═══════════════════════════════════════════════════════════════════════
       BENTO GRID — for factory floor and reference sections
       ═══════════════════════════════════════════════════════════════════════ */
    .bento-grid {
      display: grid;
      grid-template-columns: repeat(4, 1fr);
    ...
    /* ═══════════════════════════════════════════════════════════════════════
       ...
       ═══════════════════════════════════════════════════════════════════════ */
    /* R3: density rhythm → spacing shifts signal zone boundary without hard cuts */
    .transition--shift {
      margin: var(--space-12) 0;
      border-top: var(--border-micro) solid var(--color-border);
    ...
    /* ═══════════════════════════════════════════════════════════════════════
       I/O BLOCK — Input/Output display for the Idea Compiler concept
       ═══════════════════════════════════════════════════════════════════════ */
    .io-block {
      display: grid;
    ...
    /* ═══════════════════════════════════════════════════════════════════════
       FOOTER — Mirrors header. Red stripe at exit.
       ═══════════════════════════════════════════════════════════════════════ */
    footer {
      background: var(--zone-exterior);
      color: var(--color-bg);
    ...
    @media (max-width: 480px) {
      ...
      .ladder { padding: var(--space-4); }

      .ladder-level { flex-wrap: wrap; }

      .ladder-marker { margin-left: 0; }
    }
    ...
    @media print {
      ...
      .code-block, .core-abstraction-proof { background: #F5F5F0; color: black; border-color: #CCC; }
    }
  </style>
</head>
...
<body>
  ...
  <!-- ═══════════════════════════════════════════════════════════════════════
       HEADER — The Facility Entrance
       Dark exterior shell. Red alarm stripe at the threshold. The reader
       enters a world that does not apologize. The tagline introduces the
       architect's voice before any content arrives.
       ═══════════════════════════════════════════════════════════════════════ -->
  ...
  <header>
    <div class="header-inner">
      <div class="header-meta">
        ...
        <span>&middot;</span>
        <span>D-FINAL &middot; mental-models.md</span>
        <span>&middot;</span>
  ...
  <!-- ═══════════════════════════════════════════════════════════════════════
       MAIN CONTENT — Zone 1: Street Level
       Low spatial density. High semantic density. This zone breathes.
       The reader decides here whether to trust the architect.
       ═══════════════════════════════════════════════════════════════════════ -->
  <main id="main-content">
    <div class="page-container">
      ...
      <!-- ═══════════════════════════════════════════════════════════════
           TABLE OF CONTENTS — Facility Directory
           Full 14-entry navigation for the entire page. Clean, functional,
           mono-numbered. Orientation before descent.
           ═══════════════════════════════════════════════════════════════ -->
      <nav class="toc" aria-label="Table of Contents">
        <div class="toc-heading">Contents</div>
        <ol class="toc-list">
          <li><a href="#you-are-here"><span class="toc-number">&mdash;</span><span class="toc-title">You Are Here</span></a></li>
          <li><a href="#who-is-steve-yegge"><span class="toc-number">01</span><span class="toc-title">Who is Steve Yegge?</span></a></li>
          <li><a href="#gas-town-mental-model"><span class="toc-number">02</span><span class="toc-title">The Gas Town Mental Model</span></a></li>
          <li><a href="#8-roles-architecture"><span class="toc-number">03</span><span class="toc-title">The 8 Roles Architecture</span></a></li>
          <li><a href="#beads-memory-system"><span class="toc-number">04</span><span class="toc-title">Beads: The Memory System</span></a></li>
          <li><a href="#6-waves-of-ai"><span class="toc-number">05</span><span class="toc-title">The 6 Waves of AI</span></a></li>
          <li><a href="#core-principles"><span class="toc-number">06</span><span class="toc-title">Core Principles</span></a></li>
          <li><a href="#implementation-guide"><span class="toc-number">07</span><span class="toc-title">Implementation Guide</span></a></li>
          <li><a href="#checkpoints"><span class="toc-number">08</span><span class="toc-title">Checkpoints and Verification</span></a></li>
          <li><a href="#troubleshooting"><span class="toc-number">09</span><span class="toc-title">Troubleshooting</span></a></li>
          <li><a href="#when-to-use"><span class="toc-number">10</span><span class="toc-title">When to Use Gas Town</span></a></li>
          <li><a href="#quotes"><span class="toc-number">11</span><span class="toc-title">Quotes and Key Statements</span></a></li>
          <li><a href="#comparisons"><span class="toc-number">12</span><span class="toc-title">Comparison with Other Patterns</span></a></li>
          <li><a href="#sources"><span class="toc-number">13</span><span class="toc-title">Sources</span></a></li>
        </ol>
      </nav>
      ...
      <!-- ═══════════════════════════════════════════════════════════════
           ...
           The posted map at the facility entrance. Orients the reader
           on the complexity ladder. Sparse, declarative.
           ═══════════════════════════════════════════════════════════════ -->
      <section id="you-are-here" class="section" aria-label="You Are Here">
        <div class="section-meta">Orientation</div>
        <h2>You Are Here</h2>

        <!-- Complexity Ladder — the orienting schematic -->
        <!-- Conviction brief: "single orienting artifact — vertical, sharp, declarative" -->
        <div class="ladder" role="img" aria-label="Complexity Ladder showing 8 levels from Level 0 (Single Interactive Session) to Level 7 (Gas Town Factory)">
          <div class="ladder-title">The Complexity Ladder</div>
          <div class="ladder-levels">
            <div class="ladder-level ladder-level--active">
              <span class="ladder-num">Level 7</span>
              <span class="ladder-name">Gas Town Factory</span>
              <span class="ladder-marker">&larr; YOU ARE LEARNING THIS</span>
            </div>
            <div class="ladder-level">
              <span class="ladder-num">Level 6</span>
              <span class="ladder-name">Parallel Swarms + Worktrees</span>
            </div>
            <div class="ladder-level">
              <span class="ladder-num">Level 5</span>
              <span class="ladder-name">Multi-Agent Orchestration (CC Mirror)</span>
            </div>
            <div class="ladder-level">
              <span class="ladder-num">Level 4</span>
              <span class="ladder-name">PRD-Driven Loops (Full Ralph)</span>
            </div>
            <div class="ladder-level">
              <span class="ladder-num">Level 3</span>
              <span class="ladder-name">Simple Loops (Basic Ralph)</span>
            </div>
            <div class="ladder-level">
              <span class="ladder-num">Level 2</span>
              <span class="ladder-name">Subagents + Hooks</span>
            </div>
            <div class="ladder-level">
              <span class="ladder-num">Level 1</span>
              <span class="ladder-name">CLAUDE.md + Slash Commands</span>
            </div>
            <div class="ladder-level">
              <span class="ladder-num">Level 0</span>
              <span class="ladder-name">Single Interactive Session</span>
            </div>
          </div>
        </div>

        <!-- Current State — who the reader is -->
        <div class="callout callout--info" role="note">
          <div class="callout-label">Your Current State</div>
          <div class="callout-body">
            <p>You're a developer who has:</p>
            <ul class="content-list">
              <li>Mastered Levels 0&ndash;6 on the complexity ladder</li>
              <li>Run 5+ Claude Code instances simultaneously (&ldquo;juggling&rdquo; agents daily)</li>
              <li>Shipped features overnight with Ralph loops</li>
              <li>Experienced the limits of sequential processing</li>
              <li>Felt the pain of the &ldquo;Merge Wall&rdquo; with multiple agents</li>
            </ul>
          </div>
        </div>
        ...
        <!-- Prerequisites — what this demands of the reader -->
        <h3 class="subsection-heading">Prerequisites</h3>

        <ul class="checklist">
          <li><span class="check-mark"></span>Stage 7+ on Yegge's 8-Stage Dev Evolution</li>
          <li><span class="check-mark"></span>Comfort with chaos and imperfection</li>
          <li><span class="check-mark"></span>Go language runtime installed</li>
          <li><span class="check-mark"></span><code>tmux</code> proficiency (mandatory)</li>
          <li><span class="check-mark"></span>Budget: $50&ndash;200/day for API costs</li>
          <li><span class="check-mark"></span>100+ hours experience with multi-agent setups</li>
        </ul>

        <!-- R5: combination theory → gotcha after checklist provides alarm without anxiety -->
        <div class="callout callout--gotcha" role="note">
          <div class="callout-label">Complexity Level</div>
          <div class="callout-body">
            <p><strong>Level 7</strong> on the complexity ladder. This is the highest level. If the prerequisites above don't describe you, start at a lower level and return when they do.</p>
          </div>
        </div>
      </section>
      ...
      <!-- ═══════════════════════════════════════════════════════════════
           TRANSITION: You Are Here → Who is Steve Yegge
           Spacing shift — same domain (street level), different intensity.
           Moving from orientation to biography.
           ═══════════════════════════════════════════════════════════════ -->
      <div class="transition--shift" role="separator" aria-hidden="true"></div>


      <!-- ═══════════════════════════════════════════════════════════════
           SECTION 1: WHO IS STEVE YEGGE?
           Biographical. Establishes credibility fast. The reader meets
           the architect before seeing the architecture.
           ═══════════════════════════════════════════════════════════════ -->
      <section id="who-is-steve-yegge" class="section" aria-label="Who is Steve Yegge">
        <div class="section-meta">Section 01</div>
        <h2>Who is Steve Yegge?</h2>

        <!-- Professional Background -->
        <h3 class="subsection-heading">Professional Background</h3>

        <p class="drop-cap">Steve Yegge is a 40-year software development veteran with a career that provides unique credibility for building Gas Town:</p>

        <!-- Career table — mechanical precision, clean data -->
        <table class="data-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Famous for &ldquo;Stevey's Blog Rants,&rdquo; internal platforms</td>
            </tr>
            <tr>
        ...
        <!-- Why His Opinion Matters — credentials as evidence -->
        <h3 class="subsection-heading">Why His Opinion Matters</h3>

        <!-- R5: credential stats as a grid — density islands pattern -->
        <div class="credential-grid">
          <div class="credential-item">
            <div class="credential-value">~1M lines</div>
            <div class="credential-label">Vibe-coded in 2025</div>
          </div>
          <div class="credential-item">
            <div class="credential-value">225K lines</div>
            <div class="credential-label">Beads (Go) — proof at scale</div>
          </div>
          <div class="credential-item">
            <div class="credential-value">Recursive</div>
            <div class="credential-label">Built Gas Town using Gas Town</div>
          </div>
          <div class="credential-item">
            <div class="credential-value">Transparent</div>
            <div class="credential-label">Warns about chaos, costs, maturity</div>
          </div>
        </div>
        ...
        <!-- Public Presence -->
        <h3 class="subsection-heading">Public Presence</h3>
        ...
        <!-- The "Vibe Coding" Pioneer -->
        <h3 class="subsection-heading">The &ldquo;Vibe Coding&rdquo; Pioneer</h3>

        <p>Steve didn't just adopt AI-assisted development &mdash; he pioneered &ldquo;vibe coding&rdquo; as a philosophy:</p>

        <!-- Yegge's voice — pull quote bleeds margins, red alarm border -->
        <div class="pull-quote">
          <p>&ldquo;Work becomes fluid, an uncountable that you sling around freely, like slopping shiny fish into wooden barrels at the docks.&rdquo;</p>
          <cite>Steve Yegge</cite>
        </div>

        <p><strong>Vibe coding principles:</strong></p>
        <ul class="content-list">
          <li>Describe what you want (the &ldquo;vibe&rdquo;)</li>
      ...
      <!-- ═══════════════════════════════════════════════════════════════
           TRANSITION: Who is Yegge → Gas Town Mental Model
           Breathing transition — moving from biography to the core
           conceptual insight. This is the biggest shift within Zone 1.
           The reader crosses from "who built this" to "what IS this."
           ═══════════════════════════════════════════════════════════════ -->
      <!-- CD-006: bridge transitions carry semantic load -->
      <div class="transition--breathe" role="separator" aria-hidden="true"></div>


      <!-- ═══════════════════════════════════════════════════════════════
           SECTION 2: THE GAS TOWN MENTAL MODEL
           The philosophical core of Zone 1. Maximum whitespace.
           The ant/colony insight is the single idea everything serves.
           This section BREATHES — sparse spatial, dense semantic.
           ═══════════════════════════════════════════════════════════════ -->
      <section id="gas-town-mental-model" class="section" aria-label="The Gas Town Mental Model">
        <div class="section-meta">Section 02</div>
        <h2>The Gas Town Mental Model</h2>

        <!-- The Core Insight -->
        <h3 class="subsection-heading">The Core Insight</h3>

        <!-- THE DOMINANT PULL QUOTE — the single idea everything else serves -->
        <!-- Conviction brief: "most generous whitespace on the page" -->
        <!-- This is where red earns its appearance — alarm, not decoration -->
        <div class="pull-quote pull-quote--dominant">
          <p>&ldquo;Claude Code is the world's biggest fuckin' ant. Everyone is focused on making their ant run longer&hellip; when nature prefers colonies.&rdquo;</p>
          <cite>Steve Yegge</cite>
        </div>

        <p>This is the fundamental shift Gas Town represents:</p>

        <!-- Ant vs Colony — two-column stark comparison -->
        <!-- The left side (traditional) is muted; the right (Gas Town) is emphatic -->
        <div class="comparison">
          <div class="comparison-col comparison-col--old">
            <div class="comparison-heading">Traditional Approach</div>
            <div class="comparison-row">One Big Ant</div>
            <div class="comparison-row">Make it run longer</div>
            <div class="comparison-row">Context window limits everything</div>
            <div class="comparison-row">You are the programmer</div>
          </div>
          <div class="comparison-col comparison-col--new">
            <div class="comparison-heading">Gas Town Approach</div>
            <div class="comparison-row">Ant Colony</div>
            <div class="comparison-row">Build the factory</div>
            <div class="comparison-row">Multiple workers share the load</div>
            <div class="comparison-row">You are the Product Manager</div>
          </div>
        </div>

        <!-- The Factory Metaphor -->
        <h3 class="subsection-heading">The Factory Metaphor</h3>

        <p>Gas Town isn't an agent &mdash; it's a <strong>factory for agents</strong>:</p>
        ...
        <!-- The "Idea Compiler" -->
        <h3 class="subsection-heading">The &ldquo;Idea Compiler&rdquo;</h3>

        <div class="pull-quote">
          <p>&ldquo;Gas Town is an Idea Compiler. You just make up features, design them, file the implementation plans, and sling work around to your polecats and crew.&rdquo;</p>
          <cite>Steve Yegge</cite>
        </div>

        <!-- Input/Output display — showing what the compiler does -->
        <div class="io-block">
          <div>
            <div class="io-label">Input</div>
            <div class="io-value">Your ideas and feature requests</div>
          </div>
          <div class="io-arrow">&rarr;</div>
          <div>
            <div class="io-label">Output</div>
            <div class="io-value">Working code, shipped products</div>
          </div>
        </div>
        ...
        <!-- Why "Gas Town"? -->
        <h3 class="subsection-heading">Why &ldquo;Gas Town&rdquo;?</h3>
        ...
        <!-- R5: section ending with essence callout — resolution, not anxiety -->
        <div class="callout callout--essence" role="note">
          <div class="callout-label">Essence</div>
          <div class="callout-body">
            <p>The shift is not technological. It is organizational. You stop being a programmer who uses AI tools. You start being a product manager who runs an AI factory. Everything that follows &mdash; the 8 roles, the memory system, the principles &mdash; serves this single inversion.</p>
          </div>
        </div>
      </section>
  ...
  <footer>
    <div class="footer-inner">
      ...
      <span class="footer-id">D-FINAL &middot; 2026-01-18</span>
    </div>
  </footer>
