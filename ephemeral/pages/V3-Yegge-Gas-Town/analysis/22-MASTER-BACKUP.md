...
**Method:** Deduplicated, tiered by evidence strength (higher tier wins when audits disagree), cross-referenced against adversarial audit (File 23), surgery-precision preserved

---

## TABLE OF CONTENTS
1. [TIER 1 — MUST](#section-1-tier-1--must) (25 items)
...
**Total items:** 25 (9 BLOCKING enrichments + 16 additional MUST items from buddy reports and adversarial audit)
...
### MUST-07: ME-007 — Fix GR-44 False Negative (Trailing Void Measurement)
...
### MUST-13: ADV-07a — Gate-Runner Subtraction Plan (THE Prerequisite for Gate Additions)
...
### MUST-14: ADV-2-1 / ADV-7A — Gate Naming Map GR-XX <-> SC-XX
...
### MUST-24: FRESH-2-2 / FRESH-4-2 — ME-003 As Glaring Omission
...
| **How** | Same as MUST-03 — but ONLY after ADV-07a subtraction and ADV-1B-7 palette resolution |
| **Format rules** | Same as MUST-03 |
| **Anti-loss mechanisms** | Same as MUST-03 |
| **Propagation cascades** | Same as MUST-03 |
...
| **Budget impact** | Same as MUST-03 (+70 lines, requires prior -150 subtraction) |
| **In current 8-change plan?** | NO |
...
|------|------|-----------|-------------|----------|
| MUST-01 (ME-001) | BLOCKING enrichment | YES | +22 | M-04/M-20 isolation |
| MUST-02 (ME-002) | BLOCKING enrichment | YES | +14 | 7-location verdict cascade |
| MUST-03 (ME-003) | BLOCKING enrichment | NO | +70 | Palette conflict, zero budget, missing code |
| MUST-04 (ME-004) | BLOCKING enrichment | YES | +12 | M-06/M-11/M-12 verb format |
| MUST-05 (ME-005) | BLOCKING enrichment | YES | +12 across 3 files | HIGHEST CASCADE — 7+ locations |
| MUST-06 (ME-006) | BLOCKING enrichment | YES | +27 across 2 files | Builder signal missing, CSS override changes page |
| MUST-07 (ME-007) | BLOCKING enrichment | YES | +10 net-zero | Most fragile file |
| MUST-08 (ME-008) | BLOCKING enrichment | NO | +8 | ME-005 interaction undefined |
| MUST-09 (ME-009) | BLOCKING enrichment | NO | +23 across 2 files | Does not reduce Weaver volume |
| MUST-10 (ADV-1A-4) | 3-auditor optimization | NO | Net savings | Modifies ME-001 scope |
| MUST-11 (ADV-1B-7) | WCAG palette resolution | NO | Varies | MUST precede ME-003 |
| MUST-12 (ADV-1C-3) | Builder signal mechanism | NO | +6-10 | MUST accompany ME-006 |
| MUST-13 (ADV-07a) | Gate-runner subtraction | NO | -150 | MUST precede all gate additions |
| MUST-14 (ADV-2-1/7A) | Gate naming map | NO | +20-30 | BLOCKING prerequisite |
| MUST-15 (ADV-5-3) | Per-file agent architecture | NO | N/A | Implementation methodology |
| MUST-16 (ADV-06a) | Subtraction-first ordering | NO | N/A | Implementation ordering |
| MUST-17 (META-2A-3) | Detection-to-fix gap | NO | Unknown | Architectural gap |
| MUST-18 (ADV-FINAL-2) | Content experiment first | NO | $5-15, 2-4hr | May invalidate enrichments |
| MUST-19 (META-1-1) | Frame A awareness | NO | N/A | Meta-awareness |
| MUST-20 (META-5-5) | DPR-fix-only null hypothesis | NO | ~$10, ~2hr | May eliminate 80% of findings |
| MUST-21 (FRESH-5-1) | Complexity exceeds capacity | NO | N/A | Constraining |
| MUST-22 (ADV-01/02) | Capacity budget 240 lines | NO | N/A | Constraining |
| MUST-23 (ADV-7C) | Builder model experiment | NO | $5-15, 1-2hr | May redirect strategy |
| MUST-24 (FRESH-2-2) | ME-003 as glaring omission | NO | Same as ME-003 | Same as ME-003 |
| MUST-25 (FRESH-6-1) | Builder-facing artifacts | NO | +50-100 | No 4/4 example exists |
...
<!-- SECTION 2 WILL BE INSERTED HERE BY NEXT AGENT -->
<!-- Source: checklist-S2-SHOULD.md -->
<!-- Expected content: TIER 2 — SHOULD items with full detail -->
...
<!-- SECTION 7 WILL BE INSERTED HERE BY NEXT AGENT -->
<!-- Source: checklist-S6-FORMAT-S7-ANTILOSS.md (ANTILOSS portion) -->
<!-- Expected content: ANTI-LOSS VERIFICATION with 25-mechanism validation -->
...
| Audit File | Lines | Key Content |
|-----------|-------|-------------|
| 21-PHASE3-MASTER-SYNTHESIS.md | 217 | 8-change plan, 10 convergent findings, implementation order |
| audit-01-04.md | 569 | 52 V3 enrichments, 360 reservoir items, 25 anti-loss mechanisms, 53 cross-references |
| audit-05-08.md | 638 | 57-enrichment master list, adversarial review (42:1 ratio), 18 handoff, 16 pipeline PA |
| audit-09-11.md | 391 | 54 adversarial, 37 metacognitive, 33 fresh-eyes = 124 total, 7 blocking preconditions |
| audit-12-13.md | 713 | 94 style guide items, 209 structural intersection items, 5-wave plan |
| audit-14-17.md | 843 | Gate surgery (net-zero), MANIFEST surgery (+12), PA surgery (+40), 154 propagation edits |
| audit-18-21.md | 500 | 18 MISSING, 34 PARTIAL, 13 new enrichments, 5 strongest restoration cases |
| audit-mechanisms.md | 548 | 25 mechanism validations, 80 safety checks, 3 dangerous interactions |
| 23-ADVERSARIAL-CHECKLIST-AUDIT.md | 464 | 10 adversarial check categories, 154 items cataloged, 7 contradictions, 5 cross-cutting findings |
| checklist-S1-MUST.md | 462 | 25 MUST items with full surgical detail |
| **TOTAL** | **~5,345** | |

---

*Section 1 complete. 25 MUST items extracted with full surgical detail: 9 BLOCKING enrichments + 16 buddy-report MUST items. Every item includes What/Where/How/Format rules/Anti-loss/Propagation/Pre-conditions/Post-verification/Budget/Plan-status/Sources. Adversarial audit cross-referenced: all MUST-level items from File 23 are mapped to Section 1 items or tracked in later sections. Placeholder sections for S2-S8 ready for insertion by subsequent agents.*
