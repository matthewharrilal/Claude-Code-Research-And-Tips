...
Items classified COULD/CONSIDER/MINOR that are NOT in the 8-change plan. Organized by sub-category. Each item includes abbreviated context: What / Where / Budget / Loss if skipped.

---

### 3A. Gate Severity Restructure (7 items)

**COULD-01 (ME-024): Downgrade GR-07 to RECOMMENDED**
...
- Budget: +10 lines net
- Loss if skipped: Invisible browser defaults continue to trigger REQUIRED identity failures. False-positive noise.

**COULD-02 (ME-025): Downgrade GR-12 to RECOMMENDED**
...
**COULD-03 (ME-026): Downgrade GR-43 to RECOMMENDED**
...
**COULD-04 (ME-027): Downgrade GR-19 to ADVISORY**
...
**COULD-05 (ME-028): Adjust GR-21 Threshold for COMPOSED Mode**
...
**COULD-06 (ME-029): Fix GR-17 List Item Threshold**
...
**COULD-07 (ME-030): Fix GR-48/GR-49 Viewport Namespacing Conflict**
...
**COULD-08 (ME-031): False Affordance Scan PA Question**
...
**COULD-09 (ME-032): Pipeline-Introspection Markers**
...
- Flag: Fresh-eyes (audit-05-08) lists as suspicious enrichment. Metadata-only, low risk but also low impact.

**COULD-10 (ME-033): Void Question Deduplication Rule**
...
**COULD-11 (ME-034): Defect-Bypass for H's Cross-Viewport Protocol**
...
**COULD-12 (ME-035): Footer/Header in PA-02 Scope**
...
**COULD-13 (ME-036): Horizontal Scroll Element-Level Check in PA-07**
...
### 3C. Builder Recipe Improvements (3 items)

**COULD-14 (ME-038): Px-Only Border Width Instruction**
...
**COULD-15 (ME-040): Text Overflow Gate GR-62 (RECOMMENDED)**
...
- Flag: Adversarial review (ADV-07c) recommends CUTTING this entirely — lowest priority of 3 new gates, 60 lines on zero-budget artifact.

**COULD-16 (ME-041): Trailing Void Prevention in Builder Recipe**
...
**COULD-17 (ME-042): Update MANIFEST Line Counts**
...
**COULD-18 (ME-043): Add Experiential Pass + Screenshot Tracking Fields**
...
**COULD-19 (ME-044): Document Experiential Pass Rationale**
...
- Budget: +15 lines net
- Loss if skipped: Rationale for experiential pass undocumented. Future pipeline maintainers may remove it without understanding why it exists. Loses the "9 different perceptual realities" evidence — the single most communicable evidence for ME-001's necessity.
- Flag: Fresh-eyes (audit-05-08) lists as suspicious (documentation, not code). Adversarial review recommends CUTTING entirely.

**COULD-20 (ME-045): Context Budget Awareness**
...
**COULD-21 (ME-046): Corrected Screenshot Recovery Protocol**
...
### 3E. Reservoir Value-System Corrections (10 items)

**COULD-22 (ME-047): 3 Perceptually Distinct Background Registers**
...
**COULD-23 (ME-048): One Unique Visual Element Per Zone**
...
**COULD-24 (ME-049): 2-3 Dark Moments Distributed Across Scroll**
...
**COULD-25 (ME-050): Widen Spacing Compression Range to 3:1**
...
**COULD-26 (ME-052): One-Line Audience Description for PA Auditors**
...
**COULD-27 (ME-053): Container Width Per-Zone Exceptions for Code**
...
**COULD-28 (ME-054): Remove Dead CSS/Unused Tokens**
...
- Budget: -13 lines net
- Loss if skipped: Dead code persists, adding to pipeline complexity. Pure SUBTRACTION — costs nothing, reduces complexity.
- Restoration case: STRONG per audit-18-21 — -13 lines, aligns with "subtract first" principle.

**COULD-29 (ME-055): Anti-Goodhart "What Would You REMOVE?" PA Question**
...
**COULD-30 (ME-056): Codify Best CSS Patterns as Technique Library**
...
**COULD-31 (ME-057): Weaver Emotional Arc to Fix Mapping**
...
- Flag: Fresh-eyes (audit-05-08) lists as suspicious enrichment.
...
#### Experiential PA Questions Pool (20 remaining candidates)

From File 02 Section B — 24 experiential questions rated STILL-USEFUL. Only 4 were selected for ME-051. The remaining 20 form a backlog for future question portfolio rebalancing:
...
Items identified in handoff enrichments (File 07) and pipeline PA enrichments (File 08) that were NOT merged into the master enrichment list and have no ME number:
...
|-------------|-----------|----------------|
| Gate Severity Restructure (COULD-01 to COULD-07) | 7 | +50 |
| PA Enrichments (COULD-08 to COULD-13) | 6 | +38 |
| Builder Recipe (COULD-14 to COULD-16) | 3 | +66 |
| Tracking/Docs (COULD-17 to COULD-21) | 5 | +45 |
| Reservoir Value-System (COULD-22 to COULD-31) | 10 | +62 |
| Un-numbered File 07/08 items | 10 | ~+30 est |
| Reservoir STILL-USEFUL (no ME) | ~42 | ~+150 est |
| **TOTAL COULD** | **~83** | **~+441 est** |
...
1. COULD-28 / ME-054 (dead CSS removal): **-13 lines** — pure subtraction
2. COULD-12 + COULD-13 / ME-035 + ME-036 (PA question extensions): **+2 lines** — virtually free
3. COULD-21 / ME-046 (screenshot recovery): **+5 lines** — completes ME-006
4. COULD-14 / ME-038 (px-only borders): **+3 lines** — prevents known GR-09 failures
...
Every gap, missing item, unresolved question, and uncaptured finding from the audit corpus. Numbered sequentially GAP-01 through GAP-XX.
...
- Why unresolved: No enrichment addresses responsive layout reorganization. Builder recipe is silent on breakpoints.
- Potential future action: NEW-01 — Add responsive breakpoint specification (768px, 480px) to artifact-builder-recipe.md.
...
- Source: step4-pa-epsilon.md
- Why unresolved: Table responsiveness is not covered by any gate, PA question, or builder instruction.
- Potential future action: NEW-01 (combined with GAP-01).

**GAP-03: Metaphor Structural Embedding Not Enforced**
- Description: Metaphor announced in language ("gas town," "settlement") but not embedded in layout or typography. No enrichment strengthens metaphor enforcement. step4-pa-zeta.md has 0% FULL enrichment coverage — the lowest of any Phase 2 report. The metaphor/coherence domain is a structural blind spot.
- Source: step4-pa-zeta.md
- Why unresolved: Metaphor enforcement is TC Brief territory. No gate or PA question checks for structural (not just announced) metaphor.
- Potential future action: Strengthen TC Brief guidance for metaphor expression in layout/typography.
...
- Why unresolved: ME-017 (Phase 4) partially addresses by applying fixes within a run, but was deferred. The paradigm-level question remains: should the pipeline be iterative?
- Potential future action: Architecture decision on single-pass vs iterative pipeline.
...
- Source: step-paradigm-analysis.md
- Why unresolved: Taste is fundamentally difficult to quantify. Binary gates cannot capture it. Experiential PA questions approximate it but don't measure it.
- Potential future action: Accept as architectural limitation, or explore holistic scoring via Weaver.
...
- Why unresolved: Arguably unfixable within current architecture. All 9 auditors share the same LLM vision model.
- Potential future action: Would require human-in-the-loop validation (GAP-07).
...
- Source: buddy-metacognitive.md
- Why unresolved: By design — pipeline is fully automated. Adding human review changes the architecture fundamentally.
- Potential future action: Optional human review gate between PA and Weaver.
...
- Why unresolved: Component completeness is a content-level concern that no current gate or PA question targets.
- Potential future action: NEW-02 — Visual component completeness PA question.
...
- Source: inattentional-blindness-audit.md
- Why unresolved: Content accuracy verification requires understanding content semantics, which is beyond current gate capability.
- Potential future action: NEW-02 (combined with GAP-08).
...
- Why unresolved: No gate exists for invisible content detection. ME-006 (screenshot validation) partially addresses by expanding CSS overrides but the gate-level detection is absent.
- Potential future action: NEW-03 — GR-65 invisible DOM content detection gate (RECOMMENDED).
...
- Why unresolved: ME-006 partially addresses by expanding CSS overrides to force visibility, but gate-level detection of animation-gated content is absent.
- Potential future action: Gate that detects IntersectionObserver patterns and forces visibility.
...
- Why unresolved: No gate targets structural emptiness. All gates check CSS properties, not content presence.
- Potential future action: NEW-04 — GR-66 empty section detection gate (ADVISORY).

**GAP-13: Metaphor-Typography Weight Mapping**
...
- Source: step4-pa-zeta.md
- Why unresolved: Creative suggestion, not a spec change. Belongs in TC Brief guidance, not gate/builder spec.
- Potential future action: TC Brief template could include metaphor-typography mapping as an optional technique.

**GAP-14: Settlement Map Missing Legend**
- Description: Settlement Map has no legend explaining marker meanings. Visual component incompleteness.
- Source: inattentional-blindness-audit.md
- Why unresolved: Content-specific issue. No general mechanism detects missing legends.
- Potential future action: Would be caught by proposed NEW-02 (visual component completeness).

**GAP-15: Complexity Ladder Tier Count Mismatch**
- Description: Complexity Ladder diagram shows 5 tiers but text describes 6. Content accuracy failure.
- Source: inattentional-blindness-audit.md
- Why unresolved: Content-specific issue. No general mechanism detects text-diagram count mismatches.
- Potential future action: Would be caught by proposed NEW-02.

**GAP-16: Content Visibility Gate (expanded scope)**
- Description: Gate 4F scope: `opacity: 0`, off-screen positioning, `color` matching `background-color`. Broader than GAP-10 — adds color-matching-background detection.
- Source: gate-usability-audit.md Section 4F
- Why unresolved: Overlaps with GAP-10 but adds detection for text whose color matches its background.
- Potential future action: Extend NEW-03 to include color-on-matching-background detection.

**GAP-17: Image/SVG Load Verification Gate**
...
- Why unresolved: No gate checks whether images/SVGs actually loaded successfully.
- Potential future action: NEW-07 — GR-63 image/SVG load verification gate (ADVISORY).

**GAP-18: Touch Target Size Gate**
...
- Why unresolved: Accessibility gate for touch targets not implemented.
- Potential future action: Implement GR-64 as ADVISORY gate.
...
**GAP-19 (CR-3): Zone transitions at exactly 16 RGB delta (floor-hugging)**
- Description: BV-02 catches <15 but no mechanism for "technically passing but perceptually marginal."
- Source: cross-run-comparison
- Why unresolved: Gate only checks binary pass/fail at 15 RGB. No "comfortable margin" advisory exists.
- Potential future action: ME-NEW-01 proposed — BV-02 "comfortable margin" advisory: target >=25 not just >=15.

**GAP-20 (CR-5/CR-15): Zone 4 monotony persists across runs**
- Description: VA = identical blocks, V3 = plain prose. Structural blind spot.
- Source: cross-run-comparison
- Why unresolved: See Section 8B above. No gate, PA question, or builder instruction targets zone-level structural variety.
- Potential future action: ME-NEW-02 proposed — zone monotony PA question.

**GAP-21 (CR-6): Loss of decision flow diagram from VA**
- Description: V3 has no equivalent to VA's decision flow diagram.
- Source: cross-run-comparison
- Why unresolved: Creative decision, not pipeline defect. Builder chose different components.
- Potential future action: None needed — correctly NOT an enrichment.

**GAP-22 (CR-7): Loss of communication flow diagram from VA**
- Description: V3 has no equivalent to VA's communication flow diagram.
- Source: cross-run-comparison
- Why unresolved: Creative decision, same as GAP-21.
- Potential future action: None needed — correctly NOT an enrichment.

**GAP-23 (CR-8): Loss of code snippet headers (dark header bar) from VA**
- Description: V3 code blocks lack the distinctive dark header treatment.
- Source: cross-run-comparison
- Why unresolved: Creative decision. Could be addressed by ME-056 (technique library) which documents dark code block inversion as an available technique.
- Potential future action: Related to COULD-30 / ME-056.

**GAP-24 (CR-9): Print styles regression**
- Description: V3 has no print styles. VA had `@media print` rules.
- Source: cross-run-comparison
- Why unresolved: Too minor for enrichment. Not detectable by current gates.
- Potential future action: None proposed. Could add as ADVISORY gate in future.

**GAP-25 (CR-10): Loss of drop cap mechanism from VA**
- Description: V3 has no drop cap. Drop cap is a specific technique, not a requirement.
- Source: cross-run-comparison
- Why unresolved: Creative decision.
- Potential future action: None needed — correctly NOT an enrichment.

**GAP-26 (CR-16): Responsive design repeats "scale not reorganize" pattern**
- Description: Pipeline has no mechanism to evaluate responsive QUALITY — only checks responsive PRESENCE. Pattern persists across ALL runs.
- Source: cross-run-comparison
- Why unresolved: No gate or PA question evaluates whether responsive design reorganizes layout vs merely scaling it down.
- Potential future action: ME-NEW-03 proposed — responsive reorganization evaluation as PA-46 extension.

**Of 8 NOT CAPTURED items: 3 are actionable (GAP-19, GAP-20, GAP-26). 4 are creative decisions (correctly not enrichments). 1 is too minor (GAP-24). 0 are in the 8-change plan. 0 have ME numbers.**
...
### 8O. Items from Adversarial Checklist Audit Not Already Captured

The adversarial checklist audit (File 23) cataloged 154 items across 10 categories. The following items from that audit are NOT already represented in Sections 8A-8N and must be tracked:

#### Downgraded Items (severity reduced during synthesis)

| ID | Original Severity | Risk | Source |
|----|-------------------|------|--------|
| DG-01 | BLOCKING — 9 enrichments marked BLOCKING in ME list | May be downgraded to SIGNIFICANT during checklist assembly | audit-05-08 |
| DG-02 | CRITICAL — Budget violation 3.3x | May be softened to "concern" | audit-05-08 |
| DG-03 | BLOCKING — 7 blocking preconditions | May be collapsed to generic "prerequisites" | audit-09-11 |
| DG-04 | CRITICAL — 4 cross-file discrepancies | May be marked "minor" | audit-14-17 |
| DG-05 | BLOCKING — Net-zero gate-runner constraint | May be softened to "guideline" | audit-12-13 |
| DG-06 | CRITICAL — Detection without fix | May be listed as "nice to have" | audit-09-11 |
| DG-07 | CRITICAL — Builder gets nothing | May be absent entirely | audit-09-11 |
| DG-08 | CRITICAL — ARIA regression -63% | May be unmarked | audit-18-21 |

#### Mechanism Gaps (anti-loss mechanisms at risk)

| ID | Mechanism | Risk | What Breaks It |
|----|-----------|------|---------------|
| MG-01 | M-04 (context isolation) | HIGH | New experiential PA questions may leak calibration data if information isolation boundary not enforced |
| MG-02 | M-06 (brief validation) | HIGH | ME-004 adds builder Q0 content; if wrong format (checklist instead of recipe), BV-03 catches it but "fix the gate" temptation exists |
| MG-03 | M-11 (recipe enforcement) | HIGH | ME-039 anti-boilerplate changes must maintain >= 3:1 recipe:checklist verb ratio |
| MG-04 | M-12 (suppressor detection) | HIGH | New content must pass BV-04 regex. Danger: someone "fixes" the gate instead of fixing content |
| MG-05 | M-13 (verdict consistency) | HIGH | ME-005 changes verdict logic in 7+ locations. Missing ONE creates contradiction |
| MG-06 | M-19 (gate-manifest sync) | HIGH | ME-007 changes gate tiers. GR-48 arrays at L1331-1340 must match gate-manifest.json tier arrays |
| MG-07 | M-20 (fresh-eyes protocol) | HIGH | New PA questions must not contaminate fresh-eyes by containing calibration data |
| MG-08 | M-22 (PA deployment integrity) | HIGH | 11-location question total update. If one location says 70 while others say 69 = deployment failure |

#### Format Violations (implementation format rules at risk)

| ID | Rule | Common Violation |
|----|------|-----------------|
| FV-01 | PA questions must be BINARY (YES/NO with evidence) | New experiential questions written as judgment scales ("Rate 1-5") |
| FV-02 | PA questions format: `PA-[NN]: [Text ending in ?]` | Missing question mark, missing evidence format block |
| FV-03 | Recipe verbs: Read/Select/Deploy/Assess | Using checklist verbs (Verify/Fail if/Must be) instead |
| FV-04 | Binary+CSS content = 0.5x line multiplier | Treating all additions as 1.0x, understating budget impact of prose additions |
| FV-05 | Conviction language: "Does...?" not "Verify that..." | Measurement language leaking into perceptual questions |
| FV-06 | Net-zero constraint on gate-runner-core.js | Adding lines without removing equivalent count |
| FV-07 | Style guide compliance for each file type | Each file has specific formatting rules; violations compound |

#### Buddy Warnings (all 15 tracked)

| ID | Warning | Priority | Source |
|----|---------|----------|--------|
| BW-01 | Run experiment BEFORE adding rules (ADV-1A-2) | BLOCKING | Adversarial buddy |
| BW-02 | 3-auditor optimization for standard pages (ADV-1A-4) | SIGNIFICANT | Adversarial buddy |
| BW-03 | Budget violation will cascade (ADV-2A-1) | CRITICAL | Adversarial buddy |
| BW-04 | Plan adds detection without prevention (ADV-2A-3) | CRITICAL | Adversarial buddy |
| BW-05 | 42:1 add:remove ratio = complexity ratchet (ADV-3A-1) | SIGNIFICANT | Adversarial buddy |
| BW-06 | Detection-to-fix gap is architectural flaw (META-2A-3) | CRITICAL | Metacognitive buddy |
| BW-07 | Phase 3 changes nothing that builder sees (META-3A-1) | CRITICAL | Metacognitive buddy |
| BW-08 | Priority inversion: compliance over usability (META-2A-1) | SIGNIFICANT | Metacognitive buddy |
| BW-09 | Complexity already pathological; more rules = worse (META-1A-1) | BLOCKING | Metacognitive buddy |
| BW-10 | Two-instance pattern not applied (META-3A-2) | SIGNIFICANT | Metacognitive buddy |
| BW-11 | Pipeline complexity itself is the problem (FRESH-5-1) | CRITICAL | Fresh-eyes buddy |
| BW-12 | WCAG palette conflict unaddressed (FRESH-4-1) | SIGNIFICANT | Fresh-eyes buddy |
| BW-13 | Subtraction before addition (FRESH-1-1) | BLOCKING | Fresh-eyes buddy |
| BW-14 | Builder recipe needs specific CSS values (FRESH-3-1) | SIGNIFICANT | Fresh-eyes buddy |
| BW-15 | Test with simplest possible page first (FRESH-2-1) | SIGNIFICANT | Fresh-eyes buddy |

**Buddy Warning Summary:** 3 BLOCKING, 5 CRITICAL, 7 SIGNIFICANT = 15 total warnings.

#### Surgery Precision Checks (18 items)

| ID | Check | Status |
|----|-------|--------|
| SP-01 | Exact line numbers for GR-48 REQUIRED_GATES array (L1331-1340) | Must verify against actual file |
| SP-02 | Net-zero accounting: 239 freed = 239 added | Must verify arithmetic |
| SP-03 | GR-44 addition to correct tier | CONTRADICTED — File 14 vs File 17 disagree |
| SP-04 | Verdict logic MECHANICAL exception in all 7 locations | 7-location consistency untestable without reading all 7 |
| SP-05 | Gate tier changes reflected in gate-manifest.json (18->16 REQUIRED) | Provided |
| SP-06 | MANIFEST surgery +12 net lines within budget | Provided |
| SP-07 | Section 3 routing table (L179-342) UNCHANGED | Must verify |
| SP-08 | Appendix B exclusion table (L859-868) UNCHANGED | Must verify |
| SP-09 | MANIFEST.md L159+L784 total updates | Provided |
| SP-10 | PA-06, PA-09, PA-40 existence verified | Must verify (PA-07 may not exist) |
| SP-11 | 11-location propagation for question totals | Provided in audit-mechanisms |
| SP-12 | PA-05 cross-validation table (pa-deployment.md L72-92) unchanged | Must verify |
| SP-13 | Load balancing: no auditor exceeds 11 questions | Must verify post-swap |
| SP-14 | AP-05 mapping updated in pa-guardrails.md + pa-weaver.md | Must verify |
| SP-15 | 154 cascading edits enumerated | Exhaustiveness unverified |
| SP-16 | 5 orphan risks identified | Provided |
| SP-17 | 6 implicit dependencies identified | Provided |
| SP-18 | All 13 affected files listed | Provided |

#### Cross-Cutting Findings from Adversarial Audit

| # | Finding | Implication |
|---|---------|-------------|
| 1 | THE BUDGET PROBLEM IS UNRESOLVED | Three independent files quantify 2-3x over budget. No resolution exists. Checklist must contain either cut list, budget expansion, or phased plan. |
| 2 | THREE UNANIMOUS BUDDY CONVERGENCES IGNORED | Experiment first, subtraction before addition, builder is blind — 8-change plan addresses NONE. |
| 3 | DETECTION-WITHOUT-FIX PARADOX | ME-001 + ME-037/ME-051 add detection for flatness but no mechanism to fix it. Builder still receives zero compositional intelligence. |
| 4 | COMPLEXITY RATCHET ACTIVE IN AUDIT PROCESS | 154 items cataloged across 10 categories from 7 audit files. Meta:output ratio at 62.5:1, already exceeding 10:1 threshold. |
| 5 | META:OUTPUT RATIO WARNING | 30 files analyzing 8 code changes. Anti-reproduction protocol's 10:1 threshold already exceeded. |

---

### 8P. Complete Gap Statistics
...
| Downgraded severity items | 8 | 0 | 0% |
| Mechanism gaps (anti-loss at risk) | 8 | 0 | 0% |
| Format violation risks | 7 | 0 | 0% |
| Buddy warnings | 15 (3 BLOCKING, 5 CRITICAL, 7 SIGNIFICANT) | 0 | 0% |
| Surgery precision checks | 18 (7 must-verify) | 0 | 0% |
| Adversarial cross-cutting findings | 5 | 0 | 0% |
| **TOTAL** | **~196 distinct items** | **~16 partially** | **~8%** |

---

*Sections 3 and 8 complete. 83 COULD items inventoried across 9 sub-categories (3A-3I). 196 gap/unresolved items inventoried across 16 categories (8A-8P), incorporating all items from the adversarial checklist audit (File 23) not already present. The 8-change plan at ~115 lines addresses the highest-convergence items but leaves ~8% coverage of the full gap landscape. Highest-ROI additions to the plan: COULD-28/ME-054 (-13 lines), COULD-12+COULD-13/ME-035+ME-036 (+2 lines), COULD-21/ME-046 (+5 lines), COULD-14/ME-038 (+3 lines) — totaling -3 net lines.*
