# SECTION 2: TIER 2 -- SHOULD Items (SIGNIFICANT Priority)

**Section:** S2
**Scope:** Every item classified as SHOULD or SIGNIFICANT across all audit files
**Items covered:** ME-010 through ME-023 (infrastructure fixes), ME-024 through ME-030 (gate severity restructure reclassified items that interact with SHOULD), ME-031 through ME-036 (PA enrichments with SHOULD sub-items), plus buddy/gap items GAP-01, GAP-08, GAP-10, and related findings
**Sources:** audit-05-08.md, audit-01-04.md, audit-14-17.md, 09-buddy-adversarial.md, 11-buddy-fresh-eyes.md, 18-gap-check.md
