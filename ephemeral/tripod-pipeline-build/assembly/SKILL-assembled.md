...
**Agent prompt:** Read the full prompt from `ephemeral/tripod-pipeline-build/prompts/specialist-1-prompt.md` and pass the file path to the agent in its task description. The agent reads it via the Read tool — do NOT read the full prompt into your own context.
...
**Agent prompt:** Read the full prompt from `ephemeral/tripod-pipeline-build/prompts/specialist-2-prompt.md` and pass the file path to the agent in its task description. The agent reads it via the Read tool — do NOT read the full prompt into your own context.
...
**Agent prompt:** Read the full prompt from `ephemeral/tripod-pipeline-build/prompts/specialist-3-prompt.md` and pass the file path to the agent in its task description. The agent reads it via the Read tool — do NOT read the full prompt into your own context.
...
**Agent prompt:** Read the full prompt from `ephemeral/tripod-pipeline-build/prompts/specialist-4-prompt.md` and pass the file path to the agent in its task description. The agent reads it via the Read tool — do NOT read the full prompt into your own context.
...
**Agent prompt:** Read the full prompt from `ephemeral/tripod-pipeline-build/prompts/specialist-5-prompt.md` and pass the file path to the agent in its task description. The agent reads it via the Read tool — do NOT read the full prompt into your own context.
...
**Agent prompt:** Read the full prompt from `ephemeral/tripod-pipeline-build/prompts/synthesizer-prompt.md` and pass the file path to the agent in its task description. The agent reads it via the Read tool — do NOT read the full prompt into your own context.
...
**Agent prompt (Pass 1 builder instructions):** Read the full prompt from `ephemeral/tripod-pipeline-build/prompts/builder-pass-1-prompt.md` and pass the file path to the agent in its task description. The agent reads it via the Read tool — do NOT read the full prompt into your own context.
...
**Agent prompt (Pass 2 builder instructions):** Read the full prompt from `ephemeral/tripod-pipeline-build/prompts/builder-pass-2-prompt.md` and pass the file path to the agent in its task description. The agent reads it via the Read tool — do NOT read the full prompt into your own context.
...
**Agent prompt (Pass 3 builder instructions):** Read the full prompt from `ephemeral/tripod-pipeline-build/prompts/builder-pass-3-prompt.md` and pass the file path to the agent in its task description. The agent reads it via the Read tool — do NOT read the full prompt into your own context.
...
**Agent prompt:** Read the full prompt from `ephemeral/tripod-pipeline-build/prompts/refine-builder-prompt.md` and pass the file path to the agent in its task description. The agent reads it via the Read tool — do NOT read the full prompt into your own context.
...
**Installation note:** When installing this skill, copy all prompt files to `~/.claude/skills/research-compose/prompts/` alongside SKILL.md. Update paths below to match the installed location.

| Agent | Prompt File |
|-------|------------|
| TC Agent | `ephemeral/tripod-pipeline-build/prompts/tc-derivation.md` |
| Specialist 1 | `ephemeral/tripod-pipeline-build/prompts/specialist-1-prompt.md` |
| Specialist 2 | `ephemeral/tripod-pipeline-build/prompts/specialist-2-prompt.md` |
| Specialist 3 | `ephemeral/tripod-pipeline-build/prompts/specialist-3-prompt.md` |
| Specialist 4 | `ephemeral/tripod-pipeline-build/prompts/specialist-4-prompt.md` |
| Specialist 5 | `ephemeral/tripod-pipeline-build/prompts/specialist-5-prompt.md` |
| Synthesizer | `ephemeral/tripod-pipeline-build/prompts/synthesizer-prompt.md` |
| Builder Pass 1 | `ephemeral/tripod-pipeline-build/prompts/builder-pass-1-prompt.md` |
| Builder Pass 2 | `ephemeral/tripod-pipeline-build/prompts/builder-pass-2-prompt.md` |
| Builder Pass 3 | `ephemeral/tripod-pipeline-build/prompts/builder-pass-3-prompt.md` |
| PA Auditor | `ephemeral/tripod-pipeline-build/prompts/pa-auditor-prompt.md` |
| Weaver | `ephemeral/tripod-pipeline-build/prompts/weaver-prompt.md` |
| Refine Builder | `ephemeral/tripod-pipeline-build/prompts/refine-builder-prompt.md` |
