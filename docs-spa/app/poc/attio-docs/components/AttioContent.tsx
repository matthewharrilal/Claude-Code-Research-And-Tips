...
import { AttioBreadcrumbs } from './AttioBreadcrumbs'

export function AttioContent() {
  const breadcrumbs = [
  ...
  return (
    <main className="ml-[240px] mr-[200px] min-h-[calc(100vh-56px)] pt-14">
      <div className="max-w-[650px] mx-auto px-8 py-12">
        <article className="attio-content attio-docs">
          {/* Breadcrumbs */}
