...
| R-4 | 192 | 42 | 150 | 0 | 0 |
| R-5 | 39 | 39 | 0 | 0 | 0 |
| **TOTAL** | **337** | **130** | **207** | **0** | **0** |

**Application Rate:** 61.42% of findings have been applied (207/337)
**Gap Rate:** 38.58% of findings remain unapplied
...
**Note:** R-2 was DEFERRED from OD to AD (per r2-evaluation.md). AD stage consumed 25/27 R-2 findings (92.6%) with 2 SOUL FAIL excluded. R-4 was the PRIMARY research stream for AD, with 150/192 findings usable (78.1%). See R-4-AD-EVALUATION.md and r2-ad-mapping.md for full classification details.
...
- Global application rate: 9.50% → 61.42% (32 → 207 findings APPLIED out of 337)
